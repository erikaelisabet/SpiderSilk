...
path_tail_sac = "C:/Users/46705/Documents/SpiderSilk/data/pre_filtering/max_tail_sac_5_og_log.csv"

path_countdata = "C:/Users/46705/Documents/SpiderSilk/data/pre_filtering/nr_copys_df.csv"

df = pd.read_csv(path_countdata, sep=',')
...
df_filtered, coverage_across_species_full = initial_filtering(df, ['toughness',"young's_modulus", 'tensile_strength', 'strain_at_break'], fam, 20, 0.5, log=False)


# df_filtered.to_csv("C:/Users/46705/Documents/SpiderSilk/data/post_filtering/filtered_full_ara_log_20_lascID.csv", index=False)
# coverage_across_species.to_csv("C:/Users/46705/Documents/SpiderSilk/data/post_filtering/coverage_sac_tail.csv", index=False)
