...
def initial_filtering(df, mech_prop, families, filtering_threshold, zero_prop_threshold, log=False): 
       ...
       # filtered_df = data.dropna(subset=mech_prop)
...
# fam =  ["Araneidae"]
# fam =  ["Araneidae"]
fam =  ["Araneidae", "Theridiidae", "Tetragnathidae"]
...
df_filtered, coverage_across_species_full = initial_filtering(df, ['toughness',"young's_modulus", 'tensile_strength', 'strain_at_break'], fam, 180, 0.5, log=True)


df_filtered.to_csv("C:/Users/46705/Documents/SpiderSilk/data/post_filtering/filtered_3_fam.csv", index=False)
